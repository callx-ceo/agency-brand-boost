...
interface AgencyMemberDetailViewProps {
  member: AgencyMemberDetail;
  onBack: () => void;
  onUpdate: (member: AgencyMemberDetail) => void;
}
...
export const AgencyMemberDetailView: React.FC<AgencyMemberDetailViewProps> = ({ member, onBack, onUpdate }) => {
  ...
  const handleSaveVerticals = () => {
    onUpdate({ ...member, verticals: selectedVerticals });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          {member.agency && <p className="text-muted-foreground">{member.agency}</p>}
        </div>
            ...
            <CardContent className="pt-6">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-6">
                    Set bid prices for each vertical. Higher bids increase chances of receiving calls.
                  </p>
                </div>
