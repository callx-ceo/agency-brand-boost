    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{agent.onlineTime}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-3">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{agent.callTime}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-3">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-sm">{agent.lastLogin}</div>
          </CardContent>
        </Card>
      </div>
