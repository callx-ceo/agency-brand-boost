...
export const OfferRoutingStep = ({ formData, updateFormData }: OfferRoutingStepProps) => {
  ...
  // Initialize with all agents selected if none are currently assigned
  React.useEffect(() => {
  ...
  if (formData.type === "external") {
    return (
      <div className="space-y-6">
        ...
        {/* Hours of Operation section will be here for external too */}
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Same detailed hours of operation for internal offers */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Clock className="w-5 h-5" />
