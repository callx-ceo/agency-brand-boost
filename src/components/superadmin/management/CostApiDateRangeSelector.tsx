...
interface CostApiDateRangeSelectorProps {
  value: DateRange;
  onChange: (range: DateRange) => void;
  className?: string;
}

const CostApiDateRangeSelector = ({ value, onChange, className }: CostApiDateRangeSelectorProps) => {
...
export default CostApiDateRangeSelector;
